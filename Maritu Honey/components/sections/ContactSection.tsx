...
export default function ContactSection() {
  ...
  const socialLinks = [
    { name: "Facebook", url: "https://facebook.com/marituhoney", icon: <Facebook className="w-5 h-5" /> },
    { name: "Instagram", url: "https://instagram.com/marituhoney", icon: <Instagram className="w-5 h-5" /> },
    { name: "Telegram", url: "https://t.me/marituhoney", icon: <Send className="w-5 h-5" /> }
  ];
