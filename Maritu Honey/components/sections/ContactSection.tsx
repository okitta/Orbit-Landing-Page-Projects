...
export default function ContactSection() {
  ...
  const socialLinks = [
    {
      name: "TikTok",
      url: "https://www.tiktok.com/@.maritu.honey?is_from_webapp=1&sender_device=pc",
      icon: (
    ...
    {
      name: "Facebook",
      url: "https://web.facebook.com/profile.php?id=61577289740190",
      icon: <Facebook className="w-5 h-5" />
    },
    {
      name: "Telegram",
      url: "https://t.me/maritu_honey",
