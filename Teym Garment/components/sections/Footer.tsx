          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-row gap-2">
                <a href="https://www.tiktok.com/@teyimgarment" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 w-fit bg-white/10 rounded-full px-3 py-2 hover:bg-white hover:text-[#402222] transition-all duration-300">
