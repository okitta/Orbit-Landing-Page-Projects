...
export default function TestimonialsSection() {
  ...
  const testimonials: Testimonial[] = [
    ...
    {
      name: "Hana G. – Bahir Dar",
      image: "/image/testimonial.png",
      rating: 5,
      text: "Great customer service and durable products. We've used both the kneading and mixer machines—worth every cent."
    },
    {
      name: "Abel Y. – Adama",
      image: "/image/testimonial.png",
  ...
  return (
    <section className="py-32 bg-white relative overflow-hidden">
      {/* Gradient Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-steelBlue/5 to-transparent"></div>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-20">
            ...
            >
              <ChevronLeft className="h-6 w-6 text-steelBlue" />
            </Button>
          </div>
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-20">
            <Button
              ...
              className="rounded-full bg-white/80 backdrop-blur-sm hover:bg-white transition-all duration-300 hover:scale-105"
            >
              <ChevronRight className="h-6 w-6 text-steelBlue" />
            </Button>
          </div>
          ...
          <Card className="relative bg-white/80 backdrop-blur-sm border-2 border-steelBlue/10 shadow-xl max-w-3xl mx-auto transform-gpu transition-all duration-500 hover:shadow-2xl hover:scale-[1.02]">
            <CardContent className="p-8">
              <div className="flex flex-col items-center text-center">
                ...
                <blockquote className="text-xl text-charcoal italic mb-6">
                  "{testimonials[currentTestimonial].text}"
                </blockquote>
                <cite className="text-steelBlue font-semibold not-italic">
          ...
          <div className="flex justify-center gap-2 mt-8">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${index === currentTestimonial ? 'bg-steelBlue w-6' : 'bg-steelBlue/20 hover:bg-steelBlue/40'}`}
