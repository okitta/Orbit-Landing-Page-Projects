...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[80vh] sm:min-h-[90vh] md:min-h-screen flex items-center bg-steelBlue overflow-hidden">
      {/* Bubbles */}
      {bubbles.map(bubble => (
        <div
          key={bubble.id}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="max-w-2xl ml-0">
          <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 leading-tight tracking-tight text-white">
            Engineering the Future with Strength & Innovation
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 text-white/90 leading-relaxed max-w-xl sm:max-w-2xl">
            From precision-crafted steel bridges to modern-day machinery, Yared Engineering delivers durable, efficient, and forward-thinking engineering solutions for today's challenges.
          </p>
          <Button 
            size="lg" 
