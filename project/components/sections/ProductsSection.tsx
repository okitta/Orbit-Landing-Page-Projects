    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white relative">
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-[#6A1B9A] mb-4 sm:mb-6">
            Our Products
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-2xl sm:max-w-3xl lg:max-w-4xl mx-auto">
        ...
        <div className="relative">
            ...
            <div 
             ...
             >
               {products.map((product, index) => (
                 <div key={index} className="w-full sm:w-1/2 lg:w-1/3 2xl:w-1/4 flex-shrink-0 px-2 sm:px-3 lg:px-4">
                  <Card className="group overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-[1.02] transform-gpu">
                    ...
                    <CardContent className="p-4 sm:p-5 lg:p-6">
                      <div className="flex justify-between items-start mb-4">
                        <h3 className="text-lg sm:text-xl font-semibold text-[#6A1B9A]">{product.name}</h3>
                        <span className="text-base sm:text-lg font-bold text-[#FFD700]">{product.price}</span>
                      </div>
          ...
          <Button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 sm:-translate-x-4 bg-white text-[#6A1B9A] hover:bg-[#6A1B9A] hover:text-white rounded-full p-1.5 sm:p-2 shadow-lg z-10"
          >
          ...
          <Button
            onClick={handleNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 sm:translate-x-4 bg-white text-[#6A1B9A] hover:bg-[#6A1B9A] hover:text-white rounded-full p-1.5 sm:p-2 shadow-lg z-10"
          >
