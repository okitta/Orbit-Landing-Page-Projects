    ...
    <section className="py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="relative">
          ...
          <Card className="relative bg-white/80 backdrop-blur-sm border-2 border-[#6A1B9A]/10 shadow-xl max-w-3xl mx-auto transform-gpu transition-all duration-500 hover:shadow-2xl hover:scale-[1.02]">
